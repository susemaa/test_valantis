...
const FilterMenu : React.FC<FilterMenuProps> = ({ filter, setFilter }) => {
  const [isOpen, setIsOpen] = useState(false);
  const [localFilter, setLocalFilter] = useState<FilterType | null>(filter || null);
  const [activeField, setActiveField] = useState<Filters>('');
  ...
  return (
    <div className="container mx-auto mt-5">
      <div className="flex justify-between items-center p-4 bg-white border-b border-gray-200">
        ...
        <button onClick={toggleMenu} className="btn-normal">
